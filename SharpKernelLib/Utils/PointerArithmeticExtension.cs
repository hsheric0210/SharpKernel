...
namespace SharpKernelLib.Utils
{
    public static class PointerArithmeticExtension
    {
        ...
        public static IntPtr Subtract(this IntPtr ptr, IntPtr offset) => new IntPtr(ptr.ToInt64() - offset.ToInt64());
        public static IntPtr Subtract(this IntPtr ptr, UIntPtr offset) => new IntPtr((long)((ulong)ptr.ToInt64() - offset.ToUInt64()));
        ...
        public static UIntPtr Subtract(this UIntPtr ptr, UIntPtr offset) => new UIntPtr(ptr.ToUInt64() - offset.ToUInt64());
        public static UIntPtr Subtract(this UIntPtr ptr, IntPtr offset) => new UIntPtr(ptr.ToUInt64() - (ulong)offset.ToInt64());
    }
}
